  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        }, icon: Image.asset("assets/images/back.png", width: 20, height: 20 ,)),
        title: const Text("My Cats", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),),
      ),
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: [Colors.white, providerCat?.randomColor.withOpacity(0.005) ?? Colors.white])
        ),
        child: Column(
          children: [
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: Image.asset("assets/images/yes.png")),
                                        ),
                                      ),
                                    ),
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: Image.asset("assets/images/cancel.png", width: 30, height: 30,)),
                                        ),
                                      ),
                                    ),
                                  ],
